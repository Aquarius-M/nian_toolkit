...
class WidgetDetailPluggable extends StatelessWidget implements Pluggable {
  const WidgetDetailPluggable({super.key});
          ...
          MaterialPageRoute(
            builder: (ctx) {
              return Scaffold(
                ...
                appBar: AppBar(
                  elevation: 0.0,
                  title: Text("Widget详情", style: context.f18MediumTextPrimary),
                ),
              );
            },
          ),
        ...
        child: AppBar(
          ...
          title: RichText(
            text: TextSpan(
              ...
              style: context.f18MediumTextPrimary,
              children: <TextSpan>[
                TextSpan(
                  text: '  depth: ${widget.elements.length}',
                  style: context.f11RegularTextPrimary,
                ),
              ],
            ),
          ),
