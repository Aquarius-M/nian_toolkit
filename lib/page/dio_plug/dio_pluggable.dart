...
class DioPlugable extends StatefulWidget implements Pluggable {
  const DioPlugable({super.key});

  @override
  State<DioPlugable> createState() => _DioPlugableState();
...
class _DioPlugableState extends State<DioPlugable> {
  @override
  void initState() {
    super.initState();
